...
if __name__ == '__main__':
	...
	parser.add_argument('--source_img_path', type=str, default='cat/datasets/images/train')
	parser.add_argument('--source_xml_path', type=str, default='cat/datasets/labels/cat_xml')
	parser.add_argument('--save_img_path', type=str, default='cat/datasets/images/cat_strong')
	parser.add_argument('--save_xml_path', type=str, default='cat/datasets/labels/cat_strong_xml')
