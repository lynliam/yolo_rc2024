...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='E:/ronocon/jiaqiang/JPEGImages')
    parser.add_argument('--source_xml_path', type=str, default='E:/ronocon/jiaqiang/XM')
    parser.add_argument('--save_img_path', type=str, default='E:/ronocon/jiaqiang/JIA_IMG')
    parser.add_argument('--save_xml_path', type=str, default='E:/ronocon/jiaqiang/JIA_ANNO')
